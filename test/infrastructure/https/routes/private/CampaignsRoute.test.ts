...
import { CampaignsRoutes } from '@infra/https/routes/private/CampaignsRoute';

describe("CampaignsRoutes (Unit Tests)", () => {
    ...
    beforeEach(() => {
        ...
        campaignsRoutes = new CampaignsRoutes(mockController, mockAuthMiddleware);
    });
    ...
    describe("Constructor & Route Initialization", () => {
        ...
        it("debe registrar la ruta POST /register vinculada al controlador", () => {
            ...
            // Simulación de ejecución del callback del router
        ...
        it("debe registrar la ruta GET /project/:projectId vinculada al controlador", () => {
            ...
            callback({}, {}, {});
            expect(mockController.findAllByProject).toHaveBeenCalled();
        });
        ...
        it("debe registrar la ruta PUT /:id vinculada al controlador", () => {
        ...
        it("debe registrar la ruta DELETE /:id vinculada al controlador", () => {
