...
describe("RolesRoutes (Unit Tests)", () => {
    let rolesRoutes: RolesRoutes;
    ...
    beforeEach(() => {
        ...
        rolesRoutes = new RolesRoutes(mockController, mockAuthMiddleware);
    });
    ...
    describe("Constructor & Route Initialization", () => {
        ...
        it("debe aplicar el middleware de autenticación globalmente al router de roles", () => {
        ...
        it("debe registrar la ruta GET / vinculada a controller.findAllRoles", () => {
            ...
            callback(req, res, next);
            expect(mockController.findAllRoles).toHaveBeenCalledWith(req, res, next);
        });
    });
});